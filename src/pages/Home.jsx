        ...
        <section className="relative h-screen flex items-center justify-center px-4">
          ...
          <div className="relative z-10 max-w-7xl mx-auto text-center">
            ...
            >
              <Link
                to="/portfolio"
                className="px-8 py-3 bg-cyan-500 hover:bg-cyan-600 rounded-lg font-semibold transition-colors duration-300"
              >
                Explore Our Work
              </Link>
              <Link
                to="/contact"
                className="px-8 py-3 border border-cyan-500 text-cyan-500 hover:bg-cyan-500 hover:text-white rounded-lg font-semibold transition-colors duration-300"
              >
                Get in Touch
              </Link>
            </motion.div>
